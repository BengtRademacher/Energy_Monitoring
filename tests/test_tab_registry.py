...
from dashboard_tabs import OptionalTabSpec, TabDefinition, build_tab_definitions, load_optional_tab_definitions
...
class TabRegistryTests(unittest.TestCase):
    ...
    def test_missing_optional_module_is_skipped(self) -> None:
        ...
        with patch("dashboard_tabs.OPTIONAL_TAB_SPECS", (missing_spec,)):
    ...
    def test_invalid_optional_module_is_skipped(self) -> None:
        ...
        with patch("dashboard_tabs.OPTIONAL_TAB_SPECS", (broken_spec,)):
    ...
    def test_valid_optional_module_is_loaded(self) -> None:
        ...
        with patch("dashboard_tabs.OPTIONAL_TAB_SPECS", (custom_spec,)):
